...
from scripts.report_background_export_smoke_test import run_smoke_test as run_report_background_export_smoke_test
from scripts.report_image_export_smoke_test import run_smoke_test as run_report_image_export_smoke_test
from scripts.report_magazine_pdf_smoke_test import run_smoke_test as run_report_magazine_pdf_smoke_test
...
def run_full_validation() -> None:
    ...
    run_report_background_export_smoke_test()
    run_report_magazine_pdf_smoke_test()
